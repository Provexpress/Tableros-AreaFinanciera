...
export default function PurchasesKpiGrid({
  ...
  labels = {
    ...
    credit: "Notas credito de compras (NC)",
    creditDescription: "Notas credito de compras del periodo visible",
    net: "Compra neta contable de compras",
    netDescription: "Facturas de compra menos notas credito de compras",
    fcHelper: "Base contable de referencia: 100% del valor de compras visibles.",
